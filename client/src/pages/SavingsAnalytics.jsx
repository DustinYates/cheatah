      ...
      <div className="savings-analytics-grid">
        ...
        <section className="savings-analytics-card">
          ...
          <div className="metric-rows">
            ...
            <div className="metric-row savings-coming-soon">
              <span className="metric-label">
                Jackrabbit Enrollment Verification
                <span className="info-icon" data-tooltip="Cross-reference with Jackrabbit API to verify if leads who received registration links actually enrolled. This feature is coming soon.">i</span>
              </span>
              <span className="metric-value metric-value-muted">Coming soon</span>
            </div>
          </div>
        </section>
      </div>
