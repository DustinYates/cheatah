...
async def onboard_tenant():
    ...
    async with AsyncSessionLocal() as db:
        try:
            ...
            print("   - POST /api/v1/admin/sms/config")
            print("     (Requires Twilio Account SID, Auth Token, and Phone Number)")
            print("   - PUT /api/v1/sms/settings")
            print("     (Configure auto-reply, business hours, etc.)")
            print()
